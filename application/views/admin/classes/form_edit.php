    ...
    <div class="modal-body bgwhite">
        <div class="form-group">
            ...
            <div class="col-sm-8 col-xs-12">
                <input value="<?php echo $record_data->name; ?>" name="name" type="text"
                       class="col-xs-12">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8 col-xs-12">
                <input value="<?php echo $record_data->detail; ?>" name="detail" type="text"
                       class="col-xs-12">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8 col-xs-12">
                <input value="<?php echo $record_data->price; ?>" name="price" type="text" class="col-xs-12">
            </div>
        </div>
    </div>
