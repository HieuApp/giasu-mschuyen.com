...
abstract class Base_guest_layout extends CI_Controller {
    ...
    private $layout_body = "guest/base_layout/layout_body";
    private $layout_all = "guest/base_layout/layout_all";
    private $parts = Array(
        "title",
        "description",
        "favicon",
    ...
    private function set_default_title($title = NULL) {
        return $title ? $title : "Gia su Ms. Chuyen";
    }

    private function set_default_description($description = NULL) {
        return $description ? $description : "Gia su Ms. Chuyen";
    }
    ...
    private function set_default_breadcrumb() {
        $data = Array();
        $data["view_file"] = "guest/base_layout/breadcrumb";
        return $data;
    }
    ...
    private function set_default_side_bar_left() {
        ...
        $data["view_file"] = "guest/base_layout/side_bar_left";
        return $data;
    }

    private function set_default_side_bar_right() {
        $data = Array();
        $data["view_file"] = "guest/base_layout/side_bar_right";
        return $data;
    }
    ...
    private function set_default_side_bar_absolute() {
        $data = Array();
        //TODO: handle view for menu permisson at here
        $data["view_file"] = "guest/base_layout/side_bar_absolute";
        return $data;
    }

    private function set_default_footer() {
        $data = Array();
        $data["view_file"] = "guest/base_layout/footer";
        return $data;
    }

    private function set_default_assets_footer() {
        $data = Array();
        $data["view_file"] = "guest/base_layout/assets_footer";
        return $data;
    }

    private function set_default_assets_header() {
        $data = Array();
        $data["view_file"] = "guest/base_layout/assets_header";
        return $data;
    }
